        ...
        <div className="container w-1/2 mx-auto rounded-3xl mt-12 justify-center space-x-4 p-8 bg-zinc-900">
            ...
            <div className="flex flex-col mt-4">
                <form action="/contact" method="post" className="flex flex-col">
                    <div className="mb-4">
                        <label for="default-input" className=" w-full md:w-64 lg:w-96 block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                    ...
                    <div className="mb-4">
                        <label for="default-input" className=" w-full md:w-64 lg:w-96 block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                    ...
                    <div className="mb-4">
                        <label for="default-input" className="w-full md:w-64 lg:w-96 block mb-2 text-sm font-medium text-gray-900 dark:text-white">Subject</label>
                    ...
                    <div className="mt-6 flex justify-center">
                        <button type="button" className="bg-zinc-100 w-full md:w-32 lg:w-64 text-zinc-950 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Send</button>
                    </div>
                </form>
            </div>
        </div>
