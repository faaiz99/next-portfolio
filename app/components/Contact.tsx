        ...
        <AnimatePresence>
            {showModal &&
                <motion.div initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }} className="flex justify-center mt-12 mb-12">
                    <div className="max-w-xs bg-zinc-800 text-sm text-white rounded-md shadow-lg" role="alert">
                        <div className="flex p-4 text-sm font-semibold">
                            Message Sent Success
                            <div className="mt-[3px] ml-2">
                                <button type="button" className="inline-flex flex-shrink-0 justify-center items-center h-4 w-4 rounded-md text-white/[.6] hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-800 focus:ring-zinc-500 transition-all text-sm dark:focus:ring-offset-zinc-500 dark:focus:ring-zinc-700">
        ...
        <div className="flex flex-wrap justify-center md:flex md:flex-row lg:flex lg:flex-row xl:flex xl:flex-row gap-4 " id="contact" >
            <div className="flex hover:shadow-lg hover:shadow-zinc-500 bg-zinc-900 p-8 rounded-3xl  h-auto w-auto  sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 mb-4 gap-4">
                        ...
                        {({
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col">
                                <div className="mb-4">
                                    ...
                                    <input type="text" onChange={handleChange} onBlur={handleBlur} value={values.name} name='name' id="name" className=" w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block  p-2.5 " placeholder="Sample Name"></input>
                                ...
                                <div className="mt-6 flex justify-start">
                                    <button type="submit" disabled={isSubmitting} className="bg-zinc-700 w-full  hover:border-zinc-200 hover:bg-zinc-600 focus:ring-1 focus:ring-zinc-300 text-zinc-200 text-md font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 " >Send</button>
                                </div>
                            </form>
                        )}
                    </Formik>
                ...
                <div className='w-full flex flex-col mt-2'>
                    <p className=" block mb-2 text-sm font-medium text-zinc-300">  Phone</p>
                    <p className=" block mb-2 text-sm font-medium text-white">  +92332711471</p>
                    <p className=" block mb-2 text-sm font-medium text-zinc-300">Email</p>
                    <p className=" block mb-2 text-sm font-medium text-white">  faaizaslam75@live.com </p>
                    <p className=" block mb-2 text-sm font-medium text-zinc-300">Location</p>
