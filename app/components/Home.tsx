  ...
  return (
    <>
      ...
      <div
        ...
        id="intro"
      >
        <div className="hover:shadow-lg hover:shadow-zinc-500 flex flex-col items-center p-8 rounded-3xl h-auto w-96 sm:w-5/6 md:w-5/6 lg:w-5/6 xl:w-5/6 mb-4 gap-4">
          {" "}
          <Image
