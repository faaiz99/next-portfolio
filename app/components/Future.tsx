...
const Future: React.FC = () => {
  return (
    <section className="container mx-auto px-4 py-12" data-testid="future">
      <div className="text-center mb-16">
      <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-zinc-800 dark:text-zinc-200">
  The Way <span className="text-green-500 font-extrabold relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-green-600 via-green-600 to-green-700 dark:from-green-300 dark:via-green-400 dark:to-green-500">Forward</span>
</h2>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* What to Read Card */}
        <div className="hover:shadow-lg hover:shadow-zinc-300 dark:hover:shadow-zinc-500 bg-white dark:bg-zinc-900 p-6 rounded-3xl">
          ...
          <h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-200 mt-6 mb-4">Education</h3>
          <ul className="space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
          ...
          <h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-200 mt-6 mb-4">Course</h3>
          <ul className="space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
            <li className="flex items-center">
              <GreenTick />
